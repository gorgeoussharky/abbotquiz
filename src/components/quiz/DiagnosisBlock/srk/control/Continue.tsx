      ...
      <ColumnsWrap>
        <Column>
          ...
          <DiagnosisCard style={{ color: 'var(--accent)' }}>
            Учитывая субъективное улучшение состояния пациента, но сохранение
            некоторых симптомов СРК, рекомендуется продолжить лечение
          </DiagnosisCard>
          ...
          <CardsList list={usefulMaterials} title="Полезные материалы" />
        </Column>
