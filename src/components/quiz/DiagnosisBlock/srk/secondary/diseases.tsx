...
import { InterpretationItemType, Option } from '../../../../../types/interfaces';
  ...
  content: () => {
    return (
      <>
        ...
        <Text style={{ color: 'var(--accent)', fontWeight: 700 }}>
          Рекомендуется проведение пациенту дополнительный исследований для
  ...
  content: () => {
    return (
      <>
        ...
        <Text>
          В зависимости от клинических проявлений и показаний возможные
...
export const colitis = {
  ...
  content: () => {
    return (
      <>
        <DiagnosisHeading style={{ color: 'var(--accent)', fontWeight: 700 }}>
          Рекомендации по терапии
        </DiagnosisHeading>
  ...
  content: () => {
    return (
      <>
        ...
        <DiagnosisHeading>Рекомендации по терапии</DiagnosisHeading>
      ...
      <>
        ...
        <CardsList
          list={[
            ...
            {
              title:
                'Рекомендуется проведение пациенту микроскопического исследования для исключения микроскопического колита и повторное проведение илеоколоноскопии через 6-12 месяцев.',
              icon: ph,
            },
          ]}
        />
          ...
          list={[
            {
              ...
              list: [
                ...
                'Не рекомендуется использовать препараты, замедляющие моторику кишки (например, лоперамид) у пациентов с C. difficile-ассоциированной болезнью для снижения риска развития осложнений',
  ...
  content: () => {
    return (
      <>
        ...
        <Text>
          Основываясь на данных проводимых исследований и литратурных данных, у
          пациентов с ЯК могут быть эффективны следующие диеты:
        </Text>
        ...
        <CardsList
          ...
          list={[
            {
              title: 'Особая углеводная диета',
              text: `
              <span>Рекомендуется к употреблению:</span> фрукты, большинство овощей, свежие бобовые, мясо, морепродукты, твердые сыры, йогурт, ферментированный более 24 часов <br><br>
              <span>Рекомендуется избегать:</span> злаки, овощей, содержащих большое количества крахмала, большинства молочных продуктов, обработанных пищевых продуктов, искусственных подсластителей, эмульгаторов, какао, сахара, кроме меда
              `,
              icon: stomach,
            },
            {
              ...
              text: `
              <span>Рекомендуется к употреблению:</span> фрукты, большинство овощей, цельные злаки, бобовые, морепродукты, орехи, оливковое масло <br><br>
              <span>Рекомендуется избегать:</span> употребления в пищу большого количества красного мяса, сладостей, сахара, молочных продуктов, обработанных пищевых продуктов
              `,
              icon: stomach,
            },
            {
              title: 'Диета low FODMAP',
              text: `С низким содержанием олиго-ди-моносахаридов (лактозы, фруктозы, фруктанов, галактанов) и полиолов (сорбитола, ксилитола, маннитола)`,
              icon: lifestyle,
              link: '/',
              linkLabel: 'Памятка',
              linkHasArrow: true,
      ...
      <>
        <ChecksList
          list={[
            ...
            'Заболевания почек, хараткеризующиеся снижением их вункции',
...
export const highCalprotectin  = {
  ...
  subtitle: 'Повышенный уровень кальпротектина в кале может указывать на наличие у пациента одного или нескольких из следующих состояний:',
  content: () => {
    return (
      <>
        <ChecksList
...
const checkAnswer = (id: string, answer: string | number) => {
  const question = store.getState().srkExaminations.list.find((el) => el.id === id);
...
export const diseasesList = () => {
  ...
  if (
    checkAnswer(
      'feces_analysis',
      'В кале выявлены токсины А,В к Cl.difficile'
    )
  ) {
...
export const notificationsList = () => {
  ...
  if (checkAnswer('feces_consistency', 0)) {
    list.push(`
    <p style="font-size: 24px; font-weight: 700; margin-top: 0;">
  ...
  if (
    ...
    list.push(`
      ...
      <p style="font-size: 24px; font-weight: 700; margin: 0;">
      С дифференциальной диагностикой и подходами к лечению ГЭРБ можно ознакомиться в соответствующем <a style="font-size: 24px; display: inline" href="/cdss">разделе сайта</a>.
      </p>
    `);
  }
