...
const EsophagitisB = ({ onBack }: Props) => {
    ...
    <QuizWrap>
      <ColumnsWrap>
        ...
        <Column>
          ...
          <DosageList title="ИПП на выбор на срок 4-8 недель:" list={ipp} />

          <DosageList title="Прокинетик:" cols={1} list={pyro} />

          <DosageList title="Эзофагопротекторы" cols={1} list={eso} />

          <Text>
            Учитывая степень повреждения слизистой оболочки пищевода,
            рекомендовано увеличить длительность проводимой терапии на срок до 8
            недель.
          </Text>
