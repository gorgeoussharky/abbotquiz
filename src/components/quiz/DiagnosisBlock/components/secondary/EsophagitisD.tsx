...
const EsophagitisD = ({ onBack }: Props) => {
    ...
    <QuizWrap>
      <ColumnsWrap>
        ...
        <Column>
          ...
          <DosageList title="ИПП на выбор на 8 или более недель:" list={ipp} />
          ...
          <Text>
          Учитывая крайне высокую степень повреждения слизистой оболочки пищевода, рекомендуется проведение терапии сроком на 8 недель и более.
          </Text>
